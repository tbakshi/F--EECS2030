...
public class Lab0 {
	...
	public static double windChill(double airTemp, double windSpeed) {
		double windchill = 13.12 + (0.6215 * airTemp) + (0.3965 * airTemp - 11.37) * Math.pow(windSpeed, 0.16);
		return windchill;
	}
	...
	public static int compareTo(Range r1, Range r2) {
		double width1 = Math.abs((r1.getMaximum() - r1.getMinimum()));
		double width2 = Math.abs((r2.getMaximum() - r2.getMinimum()));
